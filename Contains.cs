...
{
    public class StringContainsBack : PrimoComponentSimple<MyElementUI>
    {
        ...
        public StringContainsBack(IWFContainer container) : base(container)
        {
            sdkComponentName = "String Contains";
            sdkComponentHelp = "Checks if a string is a substring of the other.";
            InitClass(container);
        }
        ...
        public override ExecutionResult SimpleAction(ScriptingData sd)
        {
            try
            {
                ...
                bool Contains = a!=null && b!=null && a.Contains(b);
                SetVariableValue(Result, Contains, typeof(bool), sd);
